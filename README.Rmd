...
[![CRAN](http://www.r-pkg.org/badges/version/PACKAGENAME)](http://cran.r-project.org/package=PACKAGENAME)
[![Build Status](https://travis-ci.org/cloudyr/PACKAGENAME.png?branch=master)](https://travis-ci.org/cloudyr/PACKAGENAME)
[![codecov.io](http://codecov.io/github/cloudyr/PACKAGENAME/coverage.svg?branch=master)](http://codecov.io/github/cloudyr/PACKAGENAME?branch=master)
